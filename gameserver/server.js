...
class ServerScene extends Phaser.Scene {
  ...
  preload() {
    this.load.tilemapTiledJSON("map", "../gameclient/assets/dungeon_map.json");
    this.load.image("rect", "../gameclient/assets/rect.png");
    this.load.image("platform", "../gameclient/assets/dungeon_map.png");
  ...
  create() {
    ...
    io.on('connection', (socket) => {
      ...
      var sprite = this.players_group.create(400, 1850, charactor_names[charindex]);
